      ...
      <div className="inline-flex justify-start">
        ...
        >
          <input
            ...
            id={`check-${item?.name}`}
          />
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-white opacity-0 peer-checked:bg-primary peer-checked:opacity-100">
            <svg
